              ...
              <div className="relative z-2 flex flex-col min-h-[22rem] p-[2.4rem] pointer-events-none">
                ...
                <div className="flex items-center mt-auto">
                  <img
                    ...
                    alt={item.title}
                  />
                  <Button className="ml-auto text-xs font-bold text-n-1 uppercase tracking-wider flex items-center transition-all duration-300 ease-in-out hover:text-blue-600 hover:scale-105" >
                    Explore now
                  </Button>
                </div>
              </div>
